...
-- AlterEnum
BEGIN;
CREATE TYPE "TaskAction_new" AS ENUM ('GITHUB_PR_OPEN', 'GITHUB_ISSUE_OPEN', 'TIMER_DATE', 'TIMER_INTERVAL',
    'GOOGLE_CREATE_NEW_EVENT', 'GOOGLE_CREATE_NEW_DOCUMENT', 'GOOGLE_CREATE_NEW_SHEET');
