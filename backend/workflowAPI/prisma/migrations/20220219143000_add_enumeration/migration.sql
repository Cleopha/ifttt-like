...
-- AlterEnum
BEGIN;
CREATE TYPE "TaskAction_new" AS ENUM ('GITHUB_PR_OPEN', 'GITHUB_ISSUE_OPEN', 'TIMER_DATE', 'TIMER_INTERVAL', 'GOOGLE_NEW_CALENDAR_EVENT', 'GOOGLE_NEW_DOC', 'GOOGLE_NEW_SHEET');
