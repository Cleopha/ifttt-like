...
export enum TaskAction {
	...
	/** ONEDRIVE_CREATE_NEW_POWER_POINT - Reaction */
	ONEDRIVE_CREATE_NEW_POWER_POINT = 16,

	/** ONEDRIVE_CREATE_NEW_FORM - Reaction */
	ONEDRIVE_CREATE_NEW_FORM = 17,

	/** NOTION_CREATE_NEW_PAGE - Action */
	NOTION_CREATE_NEW_PAGE = 18,
